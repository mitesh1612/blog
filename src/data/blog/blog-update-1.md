...
pubDatetime: 2020-12-24T00:00:00Z
author: Mitesh Shah
featured: false
draft: false
tags:
...
3. Referencing images. I had to change my image references from `[Alt Text](Image-Location)` to `![](/blog/images/Image-Location)`. Gatsby had a separate image folder for each posts versus fast pages having a single location for all the images. I will try to fix this issue if possible though.
